  ...
  return (
    <>
      ...
      <DeleteConfirmModal
        ...
        title={`Are you sure you want to delete ${productToDeleteName}?`}
        message="This means this product's customizer won't be available in online stores and will be deleted in your ecommerce platform. This action cannot be undone."
      />
    </>
  );
}
