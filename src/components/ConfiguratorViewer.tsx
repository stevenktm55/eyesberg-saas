  ...
  return (
    ...
    >
      ...
      {(shouldShowLeftSidebar || isMobileMode) && (() => {
        ...
        return (
          <div 
            className={`sidebar-white ${isMobileMode ? 'w-full border-t border-gray-200' : 'w-[420px] min-w-[420px] border-r border-gray-200'} flex-shrink-0 bg-white flex flex-col h-full overflow-hidden relative z-10`}
            style={isMobileMode ? { 
              position: 'relative',
              width: '100%', 
              borderTop: '1px solid #e5e7eb', 
            ...
            {/* IMPORTANT: flex-1 pour occuper tout l'espace restant au-dessus de la zone de boutons */}
        ...
        return (
          ...
          >
            ...
            >
              ...
              {/* Padding bas pour éviter que le dernier contenu soit masqué par l'ombre des boutons */}
              <div className="pb-4" />
            </div>

            {/* Zone des boutons fixe en bas du panneau blanc (mode preview) */}
            {propPreview && (
              <div className="p-4 border-t border-gray-200 bg-white shrink-0 z-20 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-medium shadow-sm transition-colors flex items-center justify-center gap-2"
                  >
                    <span>🛒</span>
